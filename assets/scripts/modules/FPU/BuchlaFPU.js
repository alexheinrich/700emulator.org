// import { WasmSine } from './WasmSine.js';
...
export class BuchlaFPU {
    ...
    async createProcessor() {
        await this.context.audioWorklet.addModule('/assets/scripts/modules/FPU/test-processor.js')
        // console.log(this.module)
        // console.log(Module)
        // const fib = new Fib(this.module)
        // console.log(fib.next())
        const testNode = new AudioWorkletNode(this.context, 'test-processor')
